...
import api from '../api';
import { FiCalendar, FiMapPin, FiUser, FiCreditCard, FiLink, FiPhone, FiFileText, FiKey, FiCheckCircle, FiAlertCircle, FiX, FiExternalLink, FiEdit2 } from 'react-icons/fi';
...
export default function SupplierReport() {
    ...
    const { supplier, events, payments, totalExpected, totalPaid, totalDebt = { Shekel: 0, Dollar: 0, Euro: 0 }, linkedBandExpenses = [], totalBandExpenses = { Shekel: 0 }, linkedEventExpenses = [], totalEventExpenseReimbursements = { Shekel: 0, Dollar: 0, Euro: 0 } } = report;
    const balance = {
        Shekel: totalExpected.Shekel + (totalBandExpenses.Shekel || 0) + (totalEventExpenseReimbursements.Shekel || 0) + (totalDebt.Shekel || 0) - totalPaid.Shekel,
