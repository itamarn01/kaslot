...
export default function SupplierReport() {
    ...
    const { supplier, events, payments, totalExpected, totalPaid, totalDebt = { Shekel: 0, Dollar: 0, Euro: 0 }, linkedBandExpenses = [], totalBandExpenses = { Shekel: 0 }, linkedExpenses = [] } = report;
    const balance = {
